"""
Public API for eventHorizon black hole visualization.

This module provides the main entry points for creating black hole visualizations,
including quality presets, animation wrappers, and convenience functions.
"""
import numpy as np
import pandas as pd
...
from .visualization.particle_renderer import RenderConfig
try:
    from .handlers import ModeRouter
except ImportError:
...
def benchmark_quality_levels(
    ...
    print(f"\nBenchmarking {len(quality_levels)} quality levels...")
